package user.impl.userserviceimpl;

import user.entity.AppData;
import user.entity.User;
import user.impl.validatorimpl.ValidatorImpl;
...
public class UserServiceImpl implements IUserService {
    ...
    public boolean register(String username, String password) throws IllegalAccessException {
      ...
      if (appData.getLoggedUsers()!= null){
          System.out.println("A user is already logged in: " + appData.getLoggedUsers().getUsername());
          return false;
      }
